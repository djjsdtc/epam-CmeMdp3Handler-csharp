...
{
    /// <summary>
    /// Registry of subscribed securities and their per-instrument controllers.
    ///
    /// Java: com.epam.cme.mdp3.control.InstrumentManager
    /// </summary>
    public interface IInstrumentManager
    {
        InstrumentController? GetInstrumentController(int securityId);
